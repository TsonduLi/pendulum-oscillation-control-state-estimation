...
#ifndef RTW_HEADER_sim222_h_
#define RTW_HEADER_sim222_h_
#include <math.h>
#include <string.h>
#ifndef sim222_COMMON_INCLUDES_
...
#define sim222_rtModel                 RT_MODEL_sim222_T

/* Block signals (default storage) */
typedef struct {
  real_T TransferFcn;                  /* '<Root>/Transfer Fcn' */
  real_T GainArm;                      /* '<Root>/Gain Arm' */
...
#define rtB                            sim222_B
#define BlockIO                        B_sim222_T
#define rtX                            sim222_X
#define ContinuousStates               X_sim222_T
#define rtXdot                         sim222_XDot
#define StateDerivatives               XDot_sim222_T
#define tXdis                          sim222_XDis
#define StateDisabled                  XDis_sim222_T
#define rtP                            sim222_P
#define Parameters                     P_sim222_T
#define rtDWork                        sim222_DW
#define D_Work                         DW_sim222_T
...
struct P_sim222_T_ {
  ...
  real_T TransferFcn_C[2];             /* Computed Parameter: TransferFcn_C
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  real_T GainArm_Gain;                 /* Expression: 360/9000
...
extern P_sim222_T sim222_P;

/* Block signals (default storage) */
extern B_sim222_T sim222_B;

/* Continuous states (default storage) */
extern X_sim222_T sim222_X;

/* Block states (default storage) */
extern DW_sim222_T sim222_DW;

/* Model entry point functions */
extern void sim222_initialize(void);
extern void sim222_output(void);
extern void sim222_update(void);
extern void sim222_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern sim222_rtModel *sim222(void);
...
extern RT_MODEL_sim222_T *const sim222_M;
