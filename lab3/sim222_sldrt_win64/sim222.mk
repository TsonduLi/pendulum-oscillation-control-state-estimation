...
MODEL                := sim222
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sim222_data.c sim222_tgtconn.c
MAKEFILE             := sim222.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sim222_ref.rsp
...
# additional includes
REQ_INCLUDES += ;E:/work/me-clab2/Lab03;E:/work/me-clab2/Lab03/sim222_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
