...
#ifndef RTW_HEADER_sim05_h_
#define RTW_HEADER_sim05_h_
#include <math.h>
#include <string.h>
#ifndef sim05_COMMON_INCLUDES_
...
#define sim05_rtModel                  RT_MODEL_sim05_T
...
typedef struct {
  ...
  real_T GainPendulum;                 /* '<Root>/Gain Pendulum' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } theta_deg_PWORK;                   /* '<Root>/theta_deg' */
...
#define rtB                            sim05_B
#define BlockIO                        B_sim05_T
#define rtX                            sim05_X
#define ContinuousStates               X_sim05_T
#define rtXdot                         sim05_XDot
#define StateDerivatives               XDot_sim05_T
#define tXdis                          sim05_XDis
#define StateDisabled                  XDis_sim05_T
#define rtP                            sim05_P
#define Parameters                     P_sim05_T
#define rtDWork                        sim05_DW
#define D_Work                         DW_sim05_T
...
struct P_sim05_T_ {
  ...
  int32_T AnalogOutput_VoltRange;      /* Mask Parameter: AnalogOutput_VoltRange
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  real_T Gain2_Gain;                   /* Expression: 0.025
  ...
  real_T Internal_InitialCondition;    /* Expression: 0.0
                                        * Referenced by: '<S1>/Internal'
                                        */
  real_T Onoff_Gain;                   /* Expression: 0
  ...
  real_T Constant_Value;               /* Expression: 0
                                        ...
                                        */
  real_T GainPendulum_Gain;            /* Expression: 360/2000
...
extern P_sim05_T sim05_P;

/* Block signals (default storage) */
extern B_sim05_T sim05_B;

/* Continuous states (default storage) */
extern X_sim05_T sim05_X;

/* Block states (default storage) */
extern DW_sim05_T sim05_DW;

/* Model entry point functions */
extern void sim05_initialize(void);
extern void sim05_output(void);
extern void sim05_update(void);
extern void sim05_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern sim05_rtModel *sim05(void);
...
extern RT_MODEL_sim05_T *const sim05_M;
 ...
 * '<Root>' : 'sim05'
 * '<S1>'   : 'sim05/LTI System'
 * '<S2>'   : 'sim05/LTI System/IO Delay'
 * '<S3>'   : 'sim05/LTI System/Input Delay'
 * '<S4>'   : 'sim05/LTI System/Output Delay'
 */
#endif                                 /* RTW_HEADER_sim05_h_ */
